...
declare function getComponents(components: OpenAPIV3_1.ComponentsObject): OpenAPIV3_1.ComponentsObject | {
    schemas: OpenAPIV3_1.ComponentsObject;
};
...
type DescribeRouteOptions = Omit<OpenAPIV3_1.OperationObject, "responses" | "parameters" | "operationId"> & {
