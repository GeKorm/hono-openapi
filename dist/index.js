          ...
          if (raw.schema && "toOpenAPISchema" in raw.schema) {
            ...
            if (result2.components) {
              components = mergeComponentsObjects(
                components,
                getComponents(result2.components)
              );
            }
          }
        }
...
export { ALLOWED_METHODS, describeResponse, describeRoute, generateSpecs, getComponents, openAPIRouteHandler, registerSchemaPath, removeExcludedPaths, resolver, uniqueSymbol, validator };
